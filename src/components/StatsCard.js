...
const StatsCard = ({ title, iconSrc, mainValue, totalLabel, totalValue }) => {
  return (
    <div className="Card min-w-[220px] min-h-[110px] gap-[8px] flex flex-col h-full bg-white rounded-[8px] pt-[13px] pb-[6px] px-[18px] gap-[10.5px shadow-custom">
      ...
      {totalLabel.length > 0 && totalValue.length > 0 ? (
        <>
          <div className="flex flex-row items-cflex bg-white gap-[8px] rounded-[8px] gap-[10.5px shadow-smenter justify-between">
